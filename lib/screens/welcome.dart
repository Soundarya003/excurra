        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: ResizeImage(AssetImage("images/bg3.jpg"),width: 900,height: 900),
              fit: BoxFit.cover,
            ),
          ),
          child: Column(
                       ...
                       children: [
                             ...
                             child: Padding(
                               ...
                               child: Row(
                                 ...
                                 children: [
                                   ...
                                   SizedBox(width: 25.0,),
                                   CreateDropDown(dropdownvalue: from_country,
                         ...
                         Container(
                           ...
                           child: TextButton(
                             ...
                             child: RotatedBox(
                               quarterTurns: 1,
                               child: Icon(Icons.compare_arrows_rounded,color: Colors.black,size: 30.0,),
                             ),
                           ),
                         ),
                         Expanded(
                             child: Padding(
                               ...
                               child: Row(
                                 mainAxisAlignment: MainAxisAlignment.start,
                                 children: [
                                   Icon(Icons.flight_land, color: Colors.black,),
                                   SizedBox(width: 25.0,),
                                   CreateDropDown(
                             ...
                             children: [
                               ...
                               CreateDate(
                                   ...
                                   onPressed: () async {
                                     ...
                                     setState(() {
                                       if(datepicked!=null){
                                          from_date = '${datepicked.day}-${datepicked.month}-${datepicked.year}';
                                       }
                                     });
                                   },
                               ...
                               CreateDate(
                                   ...
                                   onPressed: () async {
                                     ...
                                     setState(() {
                                       if(datepicked!=null){
                                         to_date = '${datepicked.day}-${datepicked.month}-${datepicked.year}';
                                         print(to_date);
                                        }
                                     });
                                   },
                         ...
                         Row(
                           mainAxisAlignment: MainAxisAlignment.center,
                           children: [
                             CreateButton(buttonName: 'Continue', onPressed: (){
